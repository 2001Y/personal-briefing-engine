...
- optional local SQLite state logging via `--state-db` for trigger runs and deliveries
...
- optional SQLite state wiring now exists for trigger runs / deliveries, but cursor, suppression, and feedback persistence are still future work
